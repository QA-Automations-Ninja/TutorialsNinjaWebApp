...
public class AccountPage extends BasePage {
    ...
    public void clickEditAccountInfo() {
        ...
        waitForElementToBeClickable(editAccountInfo);
    ...
    public void clickChangePassword() {
        ...
        waitForElementToBeClickable(changePasswordLink);
    ...
    public void clickLogoutFromRightColumn() {
    	  logger.info("Clicking logout option from the right column");
    	   waitForElementToBeClickable(logoutOptonFromRightColumn);
    ...
    public boolean isUserOnAccountPage() {
        ...
        waitForVisibility(myAccountHeading);
